export default function NotFoundView() {
  return `
    <div class="min-h-screen flex flex-col items-center justify-center bg-slate-100 px-4">
      ...
      <p class="text-slate-500 mt-2 text-center max-w-md">La ruta que intentas visitar no existe.</p>
      <button id="goHome" class="mt-6 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors text-sm">
        Volver al inicio
      </button>
    </div>
  `;
